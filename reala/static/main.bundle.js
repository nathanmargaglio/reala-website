...
module.exports = "<div class=\"card\">\n  <div class=\"card-content row\">\n\n    <div id=\"search_form\" class=\"col s12 center\">\n      <div class=\"input-field\">\n        <input [(ngModel)]=\"street\" id=\"street\" name=\"username\" type=\"text\" class=\"validate\">\n        <label for=\"street\">Street</label>\n      </div>\n\n      <div class=\"input-field\">\n        <input [(ngModel)]=\"zipcode\" id=\"zipcode\" name=\"zipcode\" type=\"text\" class=\"validate\">\n        <label for=\"zipcode\">Zip Code</label>\n      </div>\n\n      <a (click)=\"query()\" class=\"waves-effect waves-light btn\" id=\"query_submit_button\">search</a>\n    </div>\n\n  </div>\n</div>\n"
...
var LeadService = (function () {
    function LeadService(http) {
        ...
        this.invokeEvent = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["Subject"]();
    ...
    LeadService.prototype.leadRefresh = function () {
        this.invokeEvent.next({ value: true });
    };
    LeadService.prototype.setParams = function (params) {
        this.query_params = params;
        return this.query_params;
    };
    LeadService.prototype.getParams = function () {
        return this.query_params;
    };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__login_service__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lead_lead_service__ = __webpack_require__(15);
...
var Login = (function () {
    ...
    Login.prototype.showLogin = function (make_visible) {
        if (make_visible) {
            this.activateForm();
    ...
    Login.prototype.showLogout = function (make_visible) {
        if (make_visible) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__login_login_component__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__search_search_component__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__lead_lead_service__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__login_login_service__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_app_component__ = __webpack_require__(83);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_9__app_app_component__["a" /* AppComponent */],
            __WEBPACK_IMPORTED_MODULE_4__lead_lead_component__["a" /* Lead */],
            __WEBPACK_IMPORTED_MODULE_5__login_login_component__["a" /* Login */],
            __WEBPACK_IMPORTED_MODULE_6__search_search_component__["a" /* Search */]
        ],
        imports: [
        ...
        exports: [],
        providers: [
            __WEBPACK_IMPORTED_MODULE_7__lead_lead_service__["a" /* LeadService */],
            __WEBPACK_IMPORTED_MODULE_8__login_login_service__["a" /* LoginService */]
        ],
        bootstrap: [__WEBPACK_IMPORTED_MODULE_9__app_app_component__["a" /* AppComponent */], __WEBPACK_IMPORTED_MODULE_6__search_search_component__["a" /* Search */]],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lead_lead_service__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__login_login_component__ = __webpack_require__(52);
...
var AppComponent = (function () {
    function AppComponent(leadService) {
        ...
        this.leadsData = [];
        this.filters = '?';
        this.leadService.invokeEvent.subscribe(function (value) { return _this.toggleLeads(true); });
    }
    AppComponent.prototype.toggleLeads = function (show_leads) {
        if (show_leads) {
            this.leadsData = [];
            this.getLeads();
        }
    ...
    AppComponent.prototype.getLeads = function () {
        ...
        this.leadService.getLeads().subscribe(function (data) { return _this.populateLeads(data.results); }, function (err) { return console.error(err); }, function () {
            _this.login.showLogin(false);
            _this.login.showLogout(true);
        });
    };
    AppComponent.prototype.populateLeads = function (leads_data) {
        ...
        var res = this.login.showLoader(false);
    };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lead_service__ = __webpack_require__(15);
...
var Lead = (function () {
    ...
    Lead.prototype.getEvents = function () {
        ...
        }, function (err) { return console.error(err); }, function () { return _this.showLoader(false, _this.id); });
    };
    ...
    Lead.prototype.showLoader = function (make_visible, id) {
        if (make_visible) {
            $('#lead_loader_' + id).css('display', 'block');
        }
        else {
            $('#lead_loader_' + id).css('display', 'none');
        }
    };
...
var Search = (function () {
    ...
    Search.prototype.query = function () {
        ...
        this.leadService.setParams("postal_code=" + this.zipcode);
        console.log(this.leadService.getParams());
        this.leadService.leadRefresh();
    };
...
Search = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__lead_lead_service__["a" /* LeadService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__lead_lead_service__["a" /* LeadService */]) === "function" && _a || Object])
], Search);
